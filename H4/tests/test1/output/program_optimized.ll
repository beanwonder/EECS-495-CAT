...
define void @CAT_execution(i32 %userInput) #0 {
  ...
  %2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str, i32 0, i32 0), i64 5)
...
; <label>:6                                       ; preds = %5, %0
  ...
  %11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.2, i32 0, i32 0), i64 %10)
  ret void
}
