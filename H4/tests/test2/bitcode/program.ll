...
; <label>:7                                       ; preds = %6, %0
  ...
  %11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i32 0, i32 0), i64 %10)
  %12 = call i64 @CAT_get_signed_value(i8* %3)
  %13 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.2, i32 0, i32 0), i64 %12)
  %14 = call i64 @CAT_get_signed_value(i8* %4)
  %15 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.3, i32 0, i32 0), i64 %14)
  call void @CAT_binary_add(i8* %1, i8* %2, i8* %3)
  %16 = call i64 @CAT_get_signed_value(i8* %1)
  %17 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str, i32 0, i32 0), i64 %16)
  ...
  %21 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.2, i32 0, i32 0), i64 %20)
  %22 = call i64 @CAT_get_signed_value(i8* %4)
  %23 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.3, i32 0, i32 0), i64 %22)
...
; <label>:27                                      ; preds = %25, %7
  ...
  %29 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str, i32 0, i32 0), i64 %28)
  %30 = call i64 @CAT_get_signed_value(i8* %2)
  %31 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i32 0, i32 0), i64 %30)
  %32 = call i64 @CAT_get_signed_value(i8* %3)
  %33 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.2, i32 0, i32 0), i64 %32)
  %34 = call i64 @CAT_get_signed_value(i8* %4)
  %35 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.3, i32 0, i32 0), i64 %34)
  %36 = icmp sgt i32 %userInput, 25
  br i1 %36, label %37, label %40

; <label>:37                                      ; preds = %27
  %38 = call i64 @CAT_get_signed_value(i8* %4)
  %39 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.4, i32 0, i32 0), i64 %38)
  br label %40
