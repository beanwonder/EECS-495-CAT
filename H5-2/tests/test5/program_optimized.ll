...
define i32 @main(i32 %argc, i8** %argv) #0 {
  ...
  %7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.1, i32 0, i32 0), i64 8)
  %8 = load i8*, i8** %2, align 8
  %9 = load i8*, i8** %2, align 8
  %10 = load i8*, i8** %2, align 8
  call void @CAT_binary_add(i8* %8, i8* %9, i8* %10)
  %11 = call i64 @CAT_get_signed_value(i8* %4)
  %12 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i32 0, i32 0), i64 %11)
  %13 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.1, i32 0, i32 0), i64 8)
  ret i32 0
}
