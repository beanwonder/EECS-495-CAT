...
define i32 @main(i32 %argc, i8** %argv) #0 {
  ...
  %7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str, i32 0, i32 0), i64 8)
  %8 = load i8*, i8** %2, align 8
  %9 = call i64 @CAT_get_signed_value(i8* %8)
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i64 %9)
  %11 = load i8*, i8** %4, align 8
  %12 = call i64 @CAT_get_signed_value(i8* %11)
  %13 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.2, i32 0, i32 0), i64 %12)
